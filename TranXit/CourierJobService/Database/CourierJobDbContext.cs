...
public partial class CourierJobDbContext : DbContext
{
    ...
    public virtual DbSet<JobItemImage> JobItemImages { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<JobItemImage>(entity =>
        {
            entity.HasKey(e => e.JobItemId).HasName("PK__JobItemI__A65D44637E33E7C7");

            entity.Property(e => e.JobItemId).ValueGeneratedNever();
            entity.Property(e => e.Name).HasMaxLength(50);
            entity.Property(e => e.Type).HasMaxLength(50);

            entity.HasOne(d => d.JobItem).WithOne(p => p.JobItemImage)
                .HasForeignKey<JobItemImage>(d => d.JobItemId)
